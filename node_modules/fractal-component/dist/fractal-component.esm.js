...
import createSagaMiddleware, { eventChannel, buffers, channel, multicastChannel } from 'redux-saga';
import _regeneratorRuntime from '@babel/runtime/regenerator';
import * as rsEffects from 'redux-saga/effects';
import { take, takeMaybe, put, select, call, fork, delay, cancel, race, takeEvery, cancelled } from 'redux-saga/effects';
...
var channel$1 = function channel$$1(ch) {
...
if (typeof process === "object" && notUndef(process.env) && notUndef(process.env.NODE_ENV) && process.env.NODE_ENV === "development") {
  devMode = true;
}
...
function () {
  ...
  _proto.convertNamespacedAction = function convertNamespacedAction(action$$1, relativeDispatchPath) {
    ...
    var newAction = _extends({}, action$$1, (_extends2 = {}, _extends2[NAMESPACED] = true, _extends2.isMulticast = isMulticast, _extends2.currentSenderPath = this.cwd, _extends2.currentDispatchPath = absolutePath, _extends2.currentComponentId = this.getLastSegment(), _extends2));
...
function take$1(sagaItem, pattern$$1) {
...
function takeMaybe$1(sagaItem, pattern$$1) {
  if (!pattern$$1) throw new Error("effects.take: pattern parameter cannot be empty!");
  var chan = sagaItem.chan;
  return takeMaybe(chan, pattern$$1);
}
function put$1(sagaItem, action$$1, relativeDispatchPath) {
  if (relativeDispatchPath === void 0) {
    relativeDispatchPath = "";
  }
...
var takeEvery$1 = function takeEvery$$1(sagaItem, pattern$$1, saga) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return take$1(sagaItem, pattern$$1);

          case 3:
            action$$1 = _context.sent;
            _context.next = 6;
            return fork.apply(void 0, [saga].concat(args.concat(action$$1)));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            _context3.next = 6;
            return call.apply(void 0, [saga].concat(args.concat(action$$1)));
    ...
    return _regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return call(channel, buffers.sliding(1));

          case 2:
            throttleChannel = _context5.sent;
            _context5.next = 5;
            return takeEvery$1(sagaItem, pattern$$1,
            /*#__PURE__*/
            _regeneratorRuntime.mark(function _callee4(action$$1) {
              return _regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      _context4.next = 2;
                      return put(throttleChannel, action$$1);
          ...
          case 8:
            ...
            _context5.next = 11;
            return fork.apply(void 0, [task].concat(args, [action$$1]));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 4:
            ...
            return race({
              debounced: delay(ms),
              _action: take$1(sagaItem, pattern$$1)
            });
                ...
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
                      ...
                      _context7.next = 3;
                      return take$1(chan, pattern$$1);

                    case 3:
                      action$$1 = _context7.sent;
                      _context7.next = 6;
                      return put$1(bufferChan, action$$1);
  ...
  return _regeneratorRuntime.wrap(function forwardNamespacedAction$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return takeEvery(function (action$$1) {
            return namespacedAction(action$$1);
          },
          /*#__PURE__*/
          _regeneratorRuntime.mark(function _callee(action$$1) {
            ...
            return _regeneratorRuntime.wrap(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 8:
                    _context2.next = 10;
                    return put(sagaItem.chan, action$$1);
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          _context4.next = 10;
          return fork([this, processCommandAction], action$$1);
...
function () {
  function SagaRegistry(appContainer) {
    ...
    this.pathRegistry = new PathRegistry(true);
    this.hostSagaCommandChan = new EventChannel(buffers.expanding());
...
function () {
  ...
  _proto.serialiseAction = function serialiseAction(action$$1) {
    ...
    var newAction = _extends({}, action$$1, {
...
function () {
  function AppContainer(options) {
    ...
    if (options && options.devToolOptions) {
      containerCreationOptions.devToolOptions = _extends({}, defaultDevToolOptions, options.devToolOptions);
    }
    ...
    var sagaMiddleware = createSagaMiddleware(_extends({}, containerCreationOptions.sagaMiddlewareOptions, {
    ...
    this.store = createStore(this.reducerRegistry.createGlobalReducer(containerCreationOptions.reducer), _extends({}, containerCreationOptions.initState), composeEnhancers(applyMiddleware.apply(void 0, middlewares)));
